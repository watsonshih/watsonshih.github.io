const languages = {
    'zh-TW': {
        ...
        cloudSyncNote: "注意：雲端連結包含的資料僅暫時保存，資料可能隨時被清除，請盡速下載。",
        sessionLinkInfo: "使用此連結恢復點名狀態：",
        ...
        sessionNotFound: "在雲端找不到此點名紀錄，將重新開始。",
    ...
    'en': {
        ...
        cloudSyncNote: "Note: The data in the cloud link is temporary and may be cleared at any time. Please download it as soon as possible.",
        sessionLinkInfo: "Use this link to resume check-in status:",
        ...
        sessionNotFound: "Session not found in the cloud. Starting fresh.",
